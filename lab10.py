...
def task1():
    """
    Must return a lambda function

    Given 3 numbers, add the values together to produce a result. 

    This function will *ONLY* return a lambda that completes the task

    The function will return a lambda function
    """
    mylamb = lambda x, y, z: x+y+z
    return mylamb
